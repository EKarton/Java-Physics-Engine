...
{  
  ...
  */
  ...
  public void displayBoundingBox(boolean isBoundingBoxDisplayed) { this.isBoundingBoxDisplayed = isBoundingBoxDisplayed; }
  public void displayShapeOutline(boolean isShapeOutlineDisplayed) { this.isShapeOutlineDisplayed = isShapeOutlineDisplayed; }
  public void displayShapeFill(boolean isShapeFillDisplayed) { this.isShapeFillDisplayed = isShapeFillDisplayed; }
  public void setAntiAliasing(boolean isToggled) { this.isAntiAliasingToggled = isToggled; }  
  
  public boolean isBoundingBoxDisplayed() { return isBoundingBoxDisplayed; }
  public boolean isShapeOutlineDisplayed() { return isShapeOutlineDisplayed; }
  public boolean isShapeFillDisplayed() { return isShapeFillDisplayed; }
  public boolean isAntiAliasingToggled() { return isAntiAliasingToggled; }
  ...
  public ArrayList<PConstraints> getConstraints()
  {
    ...
    for (PConstraints constraint : createdConstraints)
    {
      ...
      if (constraint instanceof PSpring)
      {
        ...
        springCopy.setLength(((PSpring) constraint).getLength());
      ...
      else if (constraint instanceof PString)
      {
        ...
        stringCopy.setLength(((PString) constraint).getLength());
  ...
  */
  private boolean isMouseOnPoint(int mouseX, int mouseY, int posX, int posY)
  {
    ...
    if (distToPoint < TARGET_RANGE * TARGET_RANGE)
      return true;
    return false;
  }
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    else if (e.getSource() instanceof JToggleButton)
    {
      ...
      for (JToggleButton bttn : drawingBttns)
        if (bttn.equals((JToggleButton) e.getSource()) == false)
