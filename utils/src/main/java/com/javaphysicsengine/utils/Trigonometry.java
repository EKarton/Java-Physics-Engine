...
public class Trigonometry {
    ...
    /**
     * Returns the inverse of tan in degrees
    ...
    /**
     * Returns the inverse of cos in degrees
    ...
    /**
     * Returns the inverse of sin in degrees
    ...
    /**
     * Converts a beta angle (angle 0 - 90 degrees) to a theta angle (0 - 360 degrees)
